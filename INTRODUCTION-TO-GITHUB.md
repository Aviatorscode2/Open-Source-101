...
## How to Clone a Github Repository <a name="clone"></a>
...
## How to Make a Commit <a name="commit"></a>
...
## How to make a Pull Request <a name="pull"></a>
...
## GitHub Desktop vs Github CLI <a name="github-vs-cli"></a>
